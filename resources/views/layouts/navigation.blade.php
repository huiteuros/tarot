        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('games.leaderboard') }}">
                        <img src="{{ asset('logotarot.png') }}" alt="Logo" class="block h-10 w-auto" />
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <a href="{{ route('register') }}" class="text-sm text-gray-700 hover:text-gray-900 px-3 py-2 bg-gray-100 rounded-md">
                            {{ __('Register') }}
                        </a>
                    </div>
                @endauth
